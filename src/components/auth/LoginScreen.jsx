...
export const LoginScreen = ({
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-250">
      {/* Branding Title */}
      ...
      {isRegisterMode ? (
        ...
        <div className="max-w-md w-full bg-white dark:bg-slate-900 border border-slate-205 dark:border-slate-800 rounded-3xl p-8 shadow-xl space-y-6">
          ...
          {regError && (
            <div className="p-3.5 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/50 rounded-xl text-xs font-semibold text-red-600 dark:text-red-400 animate-pulse">
              ⚠️ {regError}
            </div>
          )}
          ...
          <form onSubmit={onSubmitRegister} className="space-y-4">
            ...
            <div className="flex items-center gap-2 pb-2">
              ...
              />
              <label htmlFor="regRoleCheckbox" className="text-xs font-bold text-slate-750 dark:text-slate-300 cursor-pointer select-none">
        ...
        <div className="max-w-md w-full bg-white dark:bg-slate-900 border border-slate-205 dark:border-slate-800 rounded-3xl p-8 shadow-xl space-y-6">
          ...
          {loginError && (
            <div className="p-3.5 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/50 rounded-xl text-xs font-semibold text-red-600 dark:text-red-400">
              ⚠️ {loginError}
            </div>
          )}
