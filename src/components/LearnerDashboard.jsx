          ...
          {activeCourseId && activeCourse ? (
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="divide-y divide-slate-100 dark:divide-slate-800/80 border border-slate-150 dark:border-slate-800 rounded-2xl overflow-hidden bg-slate-50/50 dark:bg-slate-950/30">
                      ...
                      <div key={mod._id} className="p-4 flex items-center justify-between gap-4">
                        <div className="flex gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-slate-500">{mod.duration} minutes bookmark lesson</p>
                          </div>
                        </div>
                        {isCompleted ? (
                ...
                <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800/80 space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    {activeCourse.isCompleted ? (
                      ...
                      <span className="text-[11px] text-slate-500">Attempt Count: {activeCourse.quizAttempts?.length || 0}</span>
                    )}
                  </div>
                      ...
                      <div key={course._id} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-5 shadow-sm flex flex-col justify-between gap-4 group">
                        ...
                        <div className="space-y-3">
                          ...
                          <button
                            ...
                            className="w-full py-1.5 bg-slate-50 hover:bg-indigo-650 hover:text-white dark:bg-slate-950 dark:hover:bg-indigo-650 border border-slate-200 dark:border-slate-800 rounded-xl text-[10px] font-bold transition-all"
                          >
              ...
              <div className="space-y-3">
                {completedList.map(course => (
                  <div key={course._id} className="p-3 bg-slate-50 dark:bg-slate-950 border border-slate-150 dark:border-slate-850 rounded-xl flex items-center justify-between">
                    <div>
                      <h4 className="text-xs font-bold text-slate-900 dark:text-slate-150 line-clamp-1">{course.title}</h4>
